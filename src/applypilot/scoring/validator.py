...
# Only block things that are impossible to claim at all — not just unfamiliar.
# Any SWE-adjacent skill (frontend, data, cloud, mobile) is fair game for a fresher.
FABRICATION_WATCHLIST: set[str] = {
    # Hard lies: fabricated credentials
    "certif", "certified", "pmp", "scrum master", "aws certified",
    # Languages that require years of dedicated use to claim plausibly
    "c#", "c++", "golang", "rust", "scala", "matlab",
}
